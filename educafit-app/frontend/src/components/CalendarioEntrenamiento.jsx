...
useEffect(() => {
  ...
  fetch("http://54.166.238.133/app-gimnasio/educafit-app/backend/obtenerEntrenamientos.php", {
    method: "POST",
...
useEffect(() => {
  ...
  fetch("http://54.166.238.133/app-gimnasio/educafit-app/backend/entrenamientoPorFecha.php", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({
      usuario_id: usuario.id,
...
const eliminarEntrenamiento = async () => {
  ...
  const res = await fetch(
    "http://54.166.238.133/app-gimnasio/educafit-app/backend/eliminarEntrenamiento.php",
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
